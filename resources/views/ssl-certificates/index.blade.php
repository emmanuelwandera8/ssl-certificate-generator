...
@section('content')
<div class="section-title">SSL Certificate Generator</div>
<div class="card">
    <div class="text-center mb-2">
        ...
        <p class="dashboard-welcome">Generate self-signed SSL certificates for development and testing</p>
        <p class="text-sm text-gray-500 mt-2">Welcome, {{ Auth::user()->name }}!</p>
    </div>
    <div class="ssl-cert-content">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <form @submit.prevent="generateCertificate" class="space-y-4">
                        ...
                        <div class="form-group">
                            <label for="common_name" class="form-label">
                                Common Name (CN) *
                            </label>
                        ...
                        <!-- Organizational Unit -->
                        <div class="form-group">
                            <label for="organizational_unit" class="form-label">
                        ...
                        <div class="form-group">
                            <label for="private_key_password" class="form-label">
